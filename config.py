...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6546726825:AAFlYjAn67ylMXDlLxVfrLJJcYSDHEXRj_I")
...
# ID Channel Database
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001975810902"))
...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgres://sprqrsdr:dFdYoGakOal_t1lbPwVhYTh1H2Kix9aI@bubble.db.elephantsql.com/sprqrsdr")
...
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001174528085"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001834563508"))
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5566485363 6349534788 5722443726").split())]
except ValueError:
